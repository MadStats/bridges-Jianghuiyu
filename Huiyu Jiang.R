...
# If I was planning to share this code in a long time, I would worry about 
# stability of the accessibility (url/data/format) and maybe backup locally.
# For class, downloading is straightforward.

# I like fread (from data.table) and read_csv (from readr).  
# in my experience, fread is faster and deals with data entry errors a little 
# more elegantly.
...
# So, I always convert to a tibble (as.tbl) after an fread.  
# tibbles are basically data.frames that print nicer.
